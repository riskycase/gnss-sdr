...
/*!
 * \brief This class is a storage and orbital model functions for the IRNSS SV
 * ephemeris data as described in IS-IRNSS-200M
 *
 * See https://www.irnss.gov/technical/icwg/IS-IRNSS-200M.pdf Appendix II
 */
class Irnss_Ephemeris : public Gnss_Ephemeris
{
public:
    /*!
     * Default constructor
    ...
    int32_t SV_accuracy{};  //!< User Range Accuracy (URA) index of the SV (reference paragraph 6.2.1) for the standard positioning service user (Ref 20.3.3.3.1.3 IS-IRNSS-200M)
...
/** \} */
/** \} */
#endif  // GNSS_SDR_IRNSS_EPHEMERIS_H
