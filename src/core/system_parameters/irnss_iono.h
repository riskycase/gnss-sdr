...
/*!
 * \brief This class is a storage for the IRNSS IONOSPHERIC data as described in IS-IRNSS-200M
 *
...
{
public:
    Irnss_Iono() = default;  //!< Default constructor
